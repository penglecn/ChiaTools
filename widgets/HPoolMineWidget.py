...
from ui.HPoolMineWidget import Ui_HPoolMineWidget
...
class HPoolMineWidget(QWidget, Ui_HPoolMineWidget):
    ...
    def setMainWindow(self, win):
        ...
        if auto_start:
            idx = self.main_window.tabWidget.indexOf(self.main_window.tabHPoolMine)
    ...
    def mineTerminated(self):
        ...
        index = self.main_window.tabWidget.indexOf(self.main_window.tabHPoolMine)
