...
class Ui_FoldersWidget(object):
    def setupUi(self, FoldersWidget):
        ...
        self.labelTotalSpace = QtWidgets.QLabel(self.groupBox_2)
        self.labelTotalSpace.setObjectName("labelTotalSpace")
        self.horizontalLayout_3.addWidget(self.labelTotalSpace)
        self.label_3 = QtWidgets.QLabel(self.groupBox_2)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_3.addWidget(self.label_3)
        self.labelTotalUsed = QtWidgets.QLabel(self.groupBox_2)
        self.labelTotalUsed.setObjectName("labelTotalUsed")
        self.horizontalLayout_3.addWidget(self.labelTotalUsed)
        self.label_5 = QtWidgets.QLabel(self.groupBox_2)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_3.addWidget(self.label_5)
        self.labelTotalFree = QtWidgets.QLabel(self.groupBox_2)
        self.labelTotalFree.setObjectName("labelTotalFree")
        self.horizontalLayout_3.addWidget(self.labelTotalFree)
    ...
    def retranslateUi(self, FoldersWidget):
        ...
        self.label.setText(_translate("FoldersWidget", "总容量"))
        self.labelTotalSpace.setText(_translate("FoldersWidget", "20TB"))
        self.label_3.setText(_translate("FoldersWidget", " 使用容量"))
        self.labelTotalUsed.setText(_translate("FoldersWidget", "10TB"))
        self.label_5.setText(_translate("FoldersWidget", " 剩余容量"))
        self.labelTotalFree.setText(_translate("FoldersWidget", "10TB"))
