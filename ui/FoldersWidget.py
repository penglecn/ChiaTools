...
class Ui_FoldersWidget(object):
    ...
    def retranslateUi(self, FoldersWidget):
        ...
        self.labelHDDUsage.setText(_translate("FoldersWidget", "    "))
        self.labelPlotsInfo.setText(_translate("FoldersWidget", "    "))
        ...
        self.treeHDD.headerItem().setText(2, _translate("FoldersWidget", "总容量"))
        self.treeHDD.headerItem().setText(3, _translate("FoldersWidget", "已使用"))
        self.treeHDD.headerItem().setText(4, _translate("FoldersWidget", "剩余"))
        self.treeHDD.headerItem().setText(5, _translate("FoldersWidget", "Plot数"))
        self.treeHDD.headerItem().setText(6, _translate("FoldersWidget", "使用情况"))
