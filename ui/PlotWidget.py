...
class Ui_PlotWidget(object):
    def setupUi(self, PlotWidget):
        ...
        self.checkBoxContinueWhenFail = QtWidgets.QCheckBox(PlotWidget)
        self.checkBoxContinueWhenFail.setObjectName("checkBoxContinueWhenFail")
        self.horizontalLayout_4.addWidget(self.checkBoxContinueWhenFail)
        ...
        sizePolicy.setHeightForWidth(self.buttonCreateBatchPlots.sizePolicy().hasHeightForWidth())
        self.buttonCreateBatchPlots.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.buttonCreatePlot.sizePolicy().hasHeightForWidth())
        self.buttonCreatePlot.setSizePolicy(sizePolicy)
        self.buttonCreatePlot.setAutoDefault(False)
        self.buttonCreatePlot.setDefault(True)
        self.buttonCreatePlot.setFlat(False)
    ...
    def retranslateUi(self, PlotWidget):
        ...
        self.checkBoxContinueWhenFail.setText(_translate("PlotWidget", "失败后继续"))
